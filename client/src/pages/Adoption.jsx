...
const Adoption = () => {
  ...
  return (
    <>
    <div className="adopt-out">
      <div className="title-card-adopt">
        <div className="title-card-quote">
          {/* <p>EVERY CHILD DESERVES A FAMILY, EVERY HEART DESERVES A CHILD.</p> */}
        </div>
      </div>
      <div className="adopt-content-box">
        <div className="adopt-content-box-left">
          ...
          <p>
            There are close to 1,000 children on India’s CARINGs site. Most have
            moderate to severe special needs. Families with Indian heritage may
            wait for a direct referral from CARA of a healthier child. Families
            without Indian heritage must be open to a child with special needs.
            Waiting Children are between 6 months and 16 years of age. The India
            program includes three categories, relative to your heritage:
          </p>
        </div>
      ...
      <div className="adopt-content-box-buttons">
        <div className="adopt-content-box-buttons-1">
          ...
          <button className="adopt-page-button" onClick={()=>navigate("/children")}>children</button>
        </div>
